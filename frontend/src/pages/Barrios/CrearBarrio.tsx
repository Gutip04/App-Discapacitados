...
export default function CrearBarrio() {
  ...
  const zonaNombre = "Urbana"; // zona predeterminada, solo lectura
  const zonaid = 1; // id de zona predeterminado
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    BarrioService.crear({ nombre, zona_id: zonaid })
      .then(() => {
        setMensaje("Barrio creado correctamente.");
      ...
      .catch((error) => {
        ...
        if (error.response && error.response.status === 409) {
          setMensaje("El barrio ya existe.");
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <div className="bg-white shadow-lg rounded-2xl p-6">
        <h1 className="text-2xl font-extrabold mb-6 text-gray-800">Crear Barrio</h1>
